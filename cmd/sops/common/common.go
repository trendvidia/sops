...
import (
	...
	. "github.com/trendvidia/sops/v4/cmd/sops/formats"
	...
	"github.com/trendvidia/sops/v4/stores/ini"
	"github.com/trendvidia/sops/v4/stores/json"
	"github.com/trendvidia/sops/v4/stores/protowire"
	"github.com/trendvidia/sops/v4/stores/yaml"
...
func newProtowireStore(c *config.StoresConfig) Store {
	return protowire.NewStore(&c.Protowire)
}
