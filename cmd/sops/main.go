	...
	app.Commands = []cli.Command{
		...
		},
		{
			...
			Flags: append([]cli.Flag{
				...
				cli.StringFlag{
					Name:  "input-type",
					Usage: "currently ini, json, yaml, protowire, dotenv and binary are supported. If not set, sops will use the file's extension to determine the type",
				},
				cli.StringFlag{
					Name:  "output-type",
					Usage: "currently ini, json, yaml, protowire, dotenv and binary are supported. If not set, sops will use the input file's extension to determine the output format",
				},
				cli.StringFlag{
					Name:  "filename",
		...
		},
		{
			...
			Flags: append([]cli.Flag{
				...
				cli.StringFlag{
					Name:  "output-type",
					Usage: "currently json, yaml, protowire, dotenv and binary are supported. If not set, sops will use the input file's extension to determine the output format",
				},
				cli.BoolFlag{
					Name:  "ignore-mac",
